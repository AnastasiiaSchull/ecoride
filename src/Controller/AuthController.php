...
class AuthController extends AbstractController
{
    ...
    #[Route('/ajax-login', name: 'ajax_login', methods: ['POST'])]
        public function ajaxLogin(Request $request, UserPasswordHasherInterface $hasher): JsonResponse
        {
    ...
    #[Route('/ajax/header', name: 'ajax_header', methods: ['GET'])]
        public function header(): Response
        {
            return $this->render('partials/_header_auth.html.twig');
        }
    ...
    #[Route('/inscription', name: 'register_post', methods: ['POST'])]
        public function register(Request $request): Response
        {
            ...
            foreach ($roles as $roleName) {
                ...
                if ($role) {
                    $user->addRole('ROLE_' . strtoupper($role->getNom()));
                }
            }
